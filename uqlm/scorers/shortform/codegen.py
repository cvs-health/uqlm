...
class CodeGenUQ(ShortFormUQ):
    def __init__(self, llm: Optional[BaseChatModel] = None, system_prompt: Optional[str] = None, max_calls_per_min: Optional[int] = None, scorers: Optional[List[str]] = None, sampling_temperature: float = 1.0, top_k_logprobs: int = 15, length_normalize: bool = True, device: Any = None, max_length: int = 2000, sentence_transformer: str = "jinaai/jina-embeddings-v2-base-code", lang: str = "python"):
        """
